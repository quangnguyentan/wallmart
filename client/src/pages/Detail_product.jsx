...
const Detail_product = () => {
  ...
  return (
    <div className="w-full h-screen pb-10 scrollbar-hide overflow-y-scroll text-gray-500 shadow-xl bg-gray-50 px-4 flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col w-full py-4 px-2 gap-2 bg-white rounded-xl">
            ...
            <div className="flex items-center gap-4 justify-between">
                ...
                <KeyboardArrowRightIcon sx={{ fontSize  :  30}} className="cursor-pointer"/>
            </div>
        </div>
        <div className="flex flex-col w-full py-4 px-2 gap-8 bg-white rounded-xl">
            <div className="flex items-center justify-between gap-4 ">
               <div className="flex items-center gap-4 justify-center">
                <AccountCircleIcon sx={{ fontSize  :  70}} className="text-gray-300"/>
                    <div className="flex flex-col gap-1">
                        <span className="text-xl font-medium text-black">Logistic</span>
                        <span className="text-lg font-medium">ngành toàn diện</span>
           ...
           <div className="w-full flex items-center justify-center cursor-pointer">
            <div className="w-32 h-8 flex justify-center items-center rounded-full bg-gray-100 border ">
                    <span className="">Liên hệ hỗ trợ</span>
                </div>
           </div>
        </div>
        <div className="flex flex-col w-full py-4 px-2 gap-8 bg-white rounded-xl">
      ...
      <div className="fixed bottom-0 w-full h-16 bg-white">
            <div>
                <div>
